...
class Station
{
	...
	Station();
	//precondition:
	//post condition: set the pointers northTrain and southTrain to NULL. Creat a station that has 24 empty queues and no traines
	...
	bool emptyQueues(int start, char direction);     
